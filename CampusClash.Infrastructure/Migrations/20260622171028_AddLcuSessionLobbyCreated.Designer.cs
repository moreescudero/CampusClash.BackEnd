...
namespace CampusClash.Infrastructure.Migrations
{
    ...
    [Migration("20260622171028_AddLcuSessionLobbyCreated")]
    partial class AddLcuSessionLobbyCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CampusClash.Domain.Entities.LcuSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CampusClash.Domain.Entities.TournamentMatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RiotLobbyCode")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("CampusClash.Domain.Entities.LcuSession", b =>
                {
                    b.HasOne("CampusClash.Domain.Entities.TournamentMatch", "Match")
                        .WithMany()
            ...
            modelBuilder.Entity("CampusClash.Domain.Entities.TournamentMatch", b =>
                {
                    b.HasOne("CampusClash.Domain.Entities.Team", "TeamA")
                        .WithMany()
                        .HasForeignKey("TeamAId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("CampusClash.Domain.Entities.Team", "TeamB")
                        .WithMany()
                    ...
                    b.HasOne("CampusClash.Domain.Entities.Team", "Winner")
                        .WithMany()
